...
class DelimToken(MetaToken):
    ...
    def initialize() -> None:
        ...
        t = None
        t = Termin._new84("НО", DelimType.BUT)
        t.add_variant("А", False)
        t.add_variant("ОДНАКО", False)
        t.add_variant("ХОТЯ", False)
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ЕСЛИ", DelimType.IF)
        t.add_variant("В СЛУЧАЕ ЕСЛИ", False)
        DelimToken.__m_onto.add(t)
        t = Termin._new86("КОГДА", DelimType.IF, DelimToken.__m_onto)
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ТО", DelimType.THEN)
        t.add_variant("ТОГДА", False)
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ИНАЧЕ", DelimType.ELSE)
        t.add_variant("В ПРОТИВНОМ СЛУЧАЕ", False)
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ТАК КАК", DelimType.BECAUSE)
        ...
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ЧТОБЫ", DelimType.FOR)
        t.add_variant("ДЛЯ ТОГО ЧТОБЫ", False)
        DelimToken.__m_onto.add(t)
        t = Termin._new84("ЧТО", DelimType.WHAT)
        DelimToken.__m_onto.add(t)