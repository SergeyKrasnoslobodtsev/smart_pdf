...
class NGLink(object):
    ...
    @staticmethod
    def _new3687(_arg1 : 'NGLinkType', _arg2 : 'NGItem', _arg3 : 'NGItem', _arg4 : bool) -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        res.from0_ = _arg2
        res.to = _arg3
    ...
    @staticmethod
    def _new3689(_arg1 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        return res
    
    @staticmethod
    def _new3690(_arg1 : 'NGItem', _arg2 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.from0_ = _arg1
        res.typ = _arg2
        return res
    ...
    @staticmethod
    def _new3698(_arg1 : 'NGItem', _arg2 : 'VerbPhraseToken', _arg3 : 'NGLinkType') -> 'NGLink':
        res = NGLink()
        res.from0_ = _arg1
        res.to_verb = _arg2
        res.typ = _arg3
    ...
    @staticmethod
    def _new3714(_arg1 : 'NGLinkType', _arg2 : 'NGItem', _arg3 : 'VerbPhraseToken') -> 'NGLink':
        res = NGLink()
        res.typ = _arg1
        res.from0_ = _arg2
        res.to_verb = _arg3
