...
class AlgoParams:
    ...
    def _static_ctor():
        ...
        AlgoParams.PARAMS.append(AlgoParam._new3660("TransitiveCoef", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("NextModel", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("NgLink", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("List", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("VerbPlural", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("CaseAccord", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new3660("MorphAccord", 1, 3, 1))
