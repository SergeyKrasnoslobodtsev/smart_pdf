...
class UriItemToken(MetaToken):
    ...
    def attachisocontent(t0 : 'Token', spec_chars : str) -> 'UriItemToken':
        ...
        first_pass4270 = True
        while True:
            if first_pass4270: first_pass4270 = False
            else: t = t.next0_
        ...
        if (txt.tell() == 0): 
            return None
        return UriItemToken._new3457(t0, t1, Utils.toStringStringIO(txt))
    ...
    def __attach_uri_content(t0 : 'Token', chars_ : str, can_be_whitespaces : bool=False) -> 'UriItemToken':
        ...
        first_pass4271 = True
        while True:
            if first_pass4271: first_pass4271 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t != t0 and t.is_whitespace_before): 
                ...
                if (t.previous.is_hiphen): 
                    ...
                    first_pass4272 = True
                    while True:
                        if first_pass4272: first_pass4272 = False
                        else: tt1 = tt1.next0_
        ...
        if (Utils.compareStrings(tmp, "WWW", True) == 0): 
            return None
        res = UriItemToken._new3457(t0, t1, Utils.toStringStringIO(txt))
        return res
    ...
    def attach_domain_name(t0 : 'Token', check_ : bool, can_be_whitspaces : bool) -> 'UriItemToken':
        ...
        first_pass4273 = True
        while True:
            if first_pass4273: first_pass4273 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t.is_whitespace_before and t != t0): 
                ...
                if (not t.is_newline_before and can_be_whitspaces): 
                    ...
                    first_pass4274 = True
                    while True:
                        if first_pass4274: first_pass4274 = False
                        else: tt1 = tt1.next0_
                        if (not (tt1 is not None)): break
            ...
            if (not str.isalpha(ch)): 
                ...
                if (ch == '-'): 
                    if (Utils.compareStrings(Utils.toStringStringIO(txt), "vk.com", True) == 0): 
                        return UriItemToken._new3457(t0, t1, Utils.toStringStringIO(txt).lower())
            else: 
                is_ip = False
    ...
    def attach_mail_users(t1 : 'Token') -> typing.List['UriItemToken']:
        ...
        if (t1.is_char('}')): 
            ...
            first_pass4275 = True
            while True:
                if first_pass4275: first_pass4275 = False
                else: t1 = t1.previous
        ...
        first_pass4276 = True
        while True:
            if first_pass4276: first_pass4276 = False
            else: t = t.previous
            if (not (t is not None)): break
        ...
        if (txt.tell() == 0): 
            return None
        res = list()
        res.append(UriItemToken._new3457(t0, t1, Utils.toStringStringIO(txt).lower()))
        return res
    ...
    def attachisbn(t0 : 'Token') -> 'UriItemToken':
        ...
        first_pass4277 = True
        while True:
            if first_pass4277: first_pass4277 = False
            else: t = t.next0_
            if (not (t is not None)): break
    ...
    def attachbbk(t0 : 'Token') -> 'UriItemToken':
        ...
        first_pass4278 = True
        while True:
            if first_pass4278: first_pass4278 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t.is_newline_before and t != t0): 
                break
    ...
    @staticmethod
    def _new3457(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'UriItemToken':
