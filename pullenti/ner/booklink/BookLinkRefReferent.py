...
class BookLinkRefReferent(Referent):
    ...
    def get_number_diff(r1 : 'Referent', r2 : 'Referent') -> int:
        ...
        n1 = 0
        n2 = 0
        wrapn1528 = RefOutArgWrapper(0)
        inoutres529 = Utils.tryParseInt(num1, wrapn1528)
        wrapn2530 = RefOutArgWrapper(0)
        inoutres531 = Utils.tryParseInt(num2, wrapn2530)
        n1 = wrapn1528.value
        n2 = wrapn2530.value
        if (not inoutres529 or not inoutres531): 
            return None
        return n2 - n1
    
    @staticmethod
    def _new519(_arg1 : 'Referent') -> 'BookLinkRefReferent':
