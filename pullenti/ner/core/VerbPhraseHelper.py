...
class VerbPhraseHelper:
    ...
    def __try_parse_ru(t : 'Token', can_be_partition : bool, can_be_adj_partition : bool, force_parse : bool) -> 'VerbPhraseToken':
        ...
        while True:
            ...
            res.end_token = t
            it = VerbPhraseItemToken._new778(t, t, MorphCollection(t.morph))
            ...
            if (norm is None): 
                ...
                if (ty == 1 and not tt.morph.case_.is_undefined): 
                    mi = MorphWordForm._new779(MorphCase.NOMINATIVE, MorphNumber.SINGULAR, MorphGender.MASCULINE)
