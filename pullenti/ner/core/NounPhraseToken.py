...
class NounPhraseToken(MetaToken):
    ...
    def get_multivars(self) -> typing.List['NounPhraseMultivarToken']:
        ...
        while i < len(self.adjectives): 
            v = NounPhraseMultivarToken._new658(self.adjectives[i].begin_token, self.adjectives[i].end_token, self, i, i)
    ...
    def get_morph_variant(self, cas : 'MorphCase', plural : bool) -> str:
        ...
        """
        mi = MorphBaseInfo._new659(cas, MorphLang.RU)
        if (plural): 
    ...
    @staticmethod
    def _new620(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PrepositionToken') -> 'NounPhraseToken':
        res = NounPhraseToken(_arg1, _arg2)
        res.preposition = _arg3
        return res
    
    @staticmethod
    def _new3712(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection') -> 'NounPhraseToken':
        res = NounPhraseToken(_arg1, _arg2)
        res.morph = _arg3
        return res