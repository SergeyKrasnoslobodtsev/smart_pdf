...
class Termin:
    ...
    class Term:
        ...
        @staticmethod
        def _new2622(_arg1 : 'TextToken', _arg2 : bool) -> 'Term':
    ...
    class Abridge:
        ...
        def add_part(self, val : str, has_delim : bool=False) -> None:
            self.parts.append(Termin.AbridgePart._new735(val, has_delim))
        ...
        def try_attach(self, t0 : 'Token') -> 'TerminToken':
            ...
            if (self.tail is None): 
                ...
                while i < len(self.parts): 
                    ...
                    tt = tt.next0_
                    i += 1
                res = TerminToken._new736(t0, te, t0 == te)
                if (point): 
    ...
    class AbridgePart:
        ...
        @staticmethod
        def _new735(_arg1 : str, _arg2 : bool) -> 'AbridgePart':
        ...
        @staticmethod
        def _new737(_arg1 : str) -> 'AbridgePart':
            res = Termin.AbridgePart()
            res.value = _arg1
            return res
    ...
    def add_abridge(self, abr : str) -> 'Abridge':
        ...
        if (i == 0): 
            return None
        a.parts.append(Termin.AbridgePart._new737(abr[0:0+i].upper()))
                ...
                if (str.isalpha(abr[i])): 
                    ...
                    while j < len(abr): 
                        if (not str.isalpha(abr[j])): 
                            break
                        j += 1
                    p = Termin.AbridgePart._new737(abr[i:i+j - i].upper())
                    if (j < len(abr)): 
        ...
        if (self.acronym_smart is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO) and term is not None): 
            if (self.acronym_smart == term or self.acronym_smart == term0): 
                if (t0.next0_ is not None and t0.next0_.is_char('.') and not t0.is_whitespace_after): 
                    return TerminToken._new562(t0, t0.next0_, self)
                else: 
                    return TerminToken._new562(t0, t0, self)
            i = 0
            t1 = Utils.asObjectOrNull(t0, TextToken)
            ...
            if (i >= len(self.acronym)): 
                return TerminToken._new562(t0, t1, self)
        ...
        if (len(self.terms) > 0 and ((not self.ignore_terms_order or cou == 1))): 
            ...
            if (ok and i >= len(self.terms)): 
                ...
                if (has_bracket and BracketHelper.can_be_end_of_sequence(t1.next0_, False, None, False)): 
                    t1 = t1.next0_
                return TerminToken._new744(t0, t1, mc)
    ...
    def try_parse_sim(self, t0 : 'Token', simd : float, pars : 'TerminParseAttr'=TerminParseAttr.NO) -> 'TerminToken':
        ...
        if (len(self.terms) > 0): 
            ...
            return TerminToken._new750(t0, t1, mc, self)
        if (self.abridges is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO)): 
            res = None
            for a in self.abridges: 
                r = a.try_attach(t0)
    ...
    @staticmethod
    def _new84(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        return res
    
    @staticmethod
    def _new85(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        return res
    ...
    @staticmethod
    def _new86(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        return res
    ...
    @staticmethod
    def _new88(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new91(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new101(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new112(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
    ...
    @staticmethod
    def _new113(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
    ...
    @staticmethod
    def _new120(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new126(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new132(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new133(_arg1 : str, _arg2 : object, _arg3 : str) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        return res
    ...
    @staticmethod
    def _new136(_arg1 : str, _arg2 : object, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
    ...
    @staticmethod
    def _new179(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : str, _arg5 : bool, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new302(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        return res
    ...
    @staticmethod
    def _new303(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new305(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new306(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new346(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new347(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new350(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphLang', _arg5 : object, _arg6 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new351(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new355(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new504(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        return res
    
    @staticmethod
    def _new572(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object) -> 'Termin':
    ...
    @staticmethod
    def _new701(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag = _arg4
        return res
    
    @staticmethod
    def _new855(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        return res
    
    @staticmethod
    def _new1165(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        return res
    
    @staticmethod
    def _new1166(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        return res
    
    @staticmethod
    def _new1177(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.tag2 = _arg4
        return res
    ...
    @staticmethod
    def _new1181(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.acronym = _arg4
        return res
    ...
    @staticmethod
    def _new1187(_arg1 : str, _arg2 : str, _arg3 : 'MorphLang', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.lang = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new1191(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1193(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : str, _arg5 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.acronym = _arg4
        res.tag2 = _arg5
    ...
    @staticmethod
    def _new1264(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        res.tag = _arg4
        return res
    ...
    @staticmethod
    def _new1302(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
    ...
    @staticmethod
    def _new1310(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        res.tag2 = _arg4
        res.tag3 = _arg5
    ...
    @staticmethod
    def _new1419(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        return res
    
    @staticmethod
    def _new1442(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        return res
    
    @staticmethod
    def _new1445(_arg1 : str, _arg2 : str, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        return res
    ...
    @staticmethod
    def _new1456(_arg1 : str, _arg2 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.ignore_terms_order = _arg2
        return res
    
    @staticmethod
    def _new1535(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
    ...
    @staticmethod
    def _new1537(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new1583(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag3 = _arg2
        return res
    
    @staticmethod
    def _new1614(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1615(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1617(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1663(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1679(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1690(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.acronym_can_be_smart = _arg4
    ...
    @staticmethod
    def _new1700(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1715(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1719(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_smart = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1727(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1728(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1734(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1739(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : bool, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1839(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin()
        res.acronym = _arg1
        res.lang = _arg2
        return res
    ...
    @staticmethod
    def _new2118(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.acronym = _arg3
        return res
    
    @staticmethod
    def _new3104(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        return res
    
    @staticmethod
    def _new3389(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag2 = _arg4
        return res
    
    @staticmethod
    def _new3481(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3491(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3504(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        res.tag = _arg5
        res.tag2 = _arg6
    ...
    @staticmethod
    def _new3508(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new3520(_arg1 : str, _arg2 : object, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.ignore_terms_order = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new3558(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
