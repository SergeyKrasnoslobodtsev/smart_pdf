...
class InstrumentBlockReferent(Referent):
    ...
    def number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2193 = RefOutArgWrapper(0)
        inoutres2194 = Utils.tryParseInt(str0_, wrapi2193)
        i = wrapi2193.value
        if (inoutres2194): 
            return i
        return 0
    ...
    def sub_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2195 = RefOutArgWrapper(0)
        inoutres2196 = Utils.tryParseInt(str0_, wrapi2195)
        i = wrapi2195.value
        if (inoutres2196): 
            return i
        return 0
    ...
    def sub_number2(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2197 = RefOutArgWrapper(0)
        inoutres2198 = Utils.tryParseInt(str0_, wrapi2197)
        i = wrapi2197.value
        if (inoutres2198): 
            return i
        return 0
    ...
    def sub_number3(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2199 = RefOutArgWrapper(0)
        inoutres2200 = Utils.tryParseInt(str0_, wrapi2199)
        i = wrapi2199.value
        if (inoutres2200): 
            return i
        return 0
    ...
    def min_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi2201 = RefOutArgWrapper(0)
        inoutres2202 = Utils.tryParseInt(str0_, wrapi2201)
        i = wrapi2201.value
        if (inoutres2202): 
            return i
        return 0
