...
class MetaInstrumentBlock(ReferentClass):
    ...
    def initialize() -> None:
        ...
        MetaInstrumentBlock.GLOBAL_META.add_feature(InstrumentBlockReferent.ATTR_TAILNUMBER, "Номер в конце строки", 0, 1)
        ...
        MetaInstrumentBlock.GLOBAL_META.add_feature(InstrumentBlockReferent.ATTR_ERROR, "Ошибка", 0, 1)
