...
class TransportAnalyzer(Analyzer):
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        first_pass4266 = True
        while True:
            if first_pass4266: first_pass4266 = False
            else: t = t.next0_
            ...
            if (rts is not None): 
                for rt in rts: 
                    ...
                    first_pass4267 = True
                    while True:
                        if first_pass4267: first_pass4267 = False
                        ...
                        if (s.type_name == TransportReferent.ATTR_MODEL): 
                            ...
                            for k in range(2):
                                if (not str.isdigit(mod[0])): 
                                    li = [ ]
                                    wrapli3453 = RefOutArgWrapper(None)
                                    inoutres3454 = Utils.tryGetValue(objs_by_model, mod, wrapli3453)
                                    li = wrapli3453.value
                                    if (not inoutres3454): 
                                        li = list()
        ...
        first_pass4268 = True
        while True:
            if first_pass4268: first_pass4268 = False
            else: t = t.next0_
            if (not (t is not None)): break
            if (t.is_ignored): 
                continue
    ...
    def __try_attach(self, its : typing.List['TransItemToken'], attach : bool) -> typing.List['ReferentToken']:
        ...
        first_pass4269 = True
        while True:
            if first_pass4269: first_pass4269 = False
            else: i += 1
