...
class MetaToken(Token):
    ...
    def __init__(self, begin : 'Token', end : 'Token', kit_ : 'AnalysisKit'=None) -> None:
        ...
        if (begin.chars is not None): 
            self.chars = CharsInfo._new3301(begin.chars.value)
        if (begin != end): 
            t = begin.next0_
    ...
    def get_referents(self) -> typing.List['Referent']:
        ...
        first_pass4302 = True
        while True:
            if first_pass4302: first_pass4302 = False
            else: t = t.next0_
    ...
    @staticmethod
    def _new657(_arg1 : 'Token', _arg2 : 'Token', _arg3 : object) -> 'MetaToken':
        res = MetaToken(_arg1, _arg2)
        res.tag = _arg3
        return res
    
    @staticmethod
    def _new674(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection') -> 'MetaToken':
        res = MetaToken(_arg1, _arg2)
        res.morph = _arg3
        return res
    
    @staticmethod
    def _new1407(_arg1 : 'Token', _arg2 : 'Token', _arg3 : object, _arg4 : 'MorphCollection') -> 'MetaToken':
        res = MetaToken(_arg1, _arg2)
        res.tag = _arg3
        res.morph = _arg4
        return res