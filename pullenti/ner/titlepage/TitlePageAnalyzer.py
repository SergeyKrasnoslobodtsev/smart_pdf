...
class TitlePageAnalyzer(Analyzer):
    ...
    def process_referent1(self, begin : 'Token', end : 'Token') -> 'ReferentToken':
        et = None
        wrapet3422 = RefOutArgWrapper(None)
        tpr = TitlePageAnalyzer._process(begin, (0 if end is None else end.end_char), begin.kit, wrapet3422)
        et = wrapet3422.value
        if (tpr is None): 
            return None
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        et = None
        wrapet3423 = RefOutArgWrapper(None)
        tpr = TitlePageAnalyzer._process(kit.first_token, 0, kit, wrapet3423)
        et = wrapet3423.value
        if (tpr is not None): 
    ...
    def _process(begin : 'Token', max_char_pos : int, kit : 'AnalysisKit', end_token : 'Token') -> 'TitlePageReferent':
        ...
        if (term is not None and kit is not None): 
            ...
            first_pass4257 = True
            while True:
                if first_pass4257: first_pass4257 = False
                else: t = t.next0_
        ...
        first_pass4258 = True
        while True:
            if first_pass4258: first_pass4258 = False
            else: t = t.next0_
            if (not (t is not None)): break
            ...
            for r in rli: 
                if (isinstance(r, PersonReferent)): 
                    ...
                    if (typ != TitleItemToken.Types.UNDEFINED): 
                        ...
                        first_pass4259 = True
                        while True:
                            if first_pass4259: first_pass4259 = False
                            else: tt = tt.next0_
                ...
                if (isinstance(r, OrganizationReferent)): 
                    ...
                    if ("курс" in org0_.types and org0_.number is not None): 
                        i = 0
                        wrapi3424 = RefOutArgWrapper(0)
                        inoutres3425 = Utils.tryParseInt(org0_.number, wrapi3424)
                        i = wrapi3424.value
                        if (inoutres3425): 
                            if (i > 0 and (i < 8)): 
                                res.student_year = i
        ...
        if (res.date is None): 
            ...
            first_pass4260 = True
            while True:
                if first_pass4260: first_pass4260 = False
                else: t = t.next0_
