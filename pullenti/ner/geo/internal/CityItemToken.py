...
class CityItemToken(MetaToken):
            ...
            if (ci0 is None): 
                ...
                if (ci.typ == CityItemToken.ItemType.NOUN and BracketHelper.can_be_start_of_sequence(t, True, False)): 
                    ...
                    if ((br is not None and (br.length_char < 50) and t.next0_.chars.is_cyrillic_letter) and not t.next0_.chars.is_all_lower): 
                        ci0 = CityItemToken._new1440(br.begin_token, br.end_token, CityItemToken.ItemType.PROPERNAME)
    ...
    def initialize() -> None:
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1419("ГОРОД-ГЕРОЙ", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1442("МІСТО-ГЕРОЙ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1419("ГОРОД-КУРОРТ", "ГОРОД")
        t.add_abridge("Г.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1442("МІСТО-КУРОРТ", MorphLang.UA, "МІСТО")
        t.add_abridge("М.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СЕЛО")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1445("ГОРОДСКОЕ ПОСЕЛЕНИЕ", "ГП", True)
        t.add_abridge("Г.П.")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("Г.ПОС.")
        t.add_abridge("ГОР.П.")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new132("ПОСЕЛКОВОЕ ПОСЕЛЕНИЕ", "ПОСЕЛОК", CityItemToken.ItemType.NOUN)
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1419("СТОЛИЦА", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1442("СТОЛИЦЯ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СТАНЦИЯ")
        t.add_abridge("СТАНЦ.")
        ...
        t.add_abridge("НП")
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1419("РАЙОННЫЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1442("РАЙОННИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1419("ОБЛАСТНОЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1442("ОБЛАСНИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("ПОЧИНОК")
        t.tag = CityItemToken.ItemType.NOUN
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        for s in ["ЖИТЕЛЬ", "МЭР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new84(s, CityItemToken.ItemType.MISC))
        for s in ["ЖИТЕЛЬ", "МЕР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new504(s, MorphLang.UA, CityItemToken.ItemType.MISC))
        t = Termin._new84("АДМИНИСТРАЦИЯ", CityItemToken.ItemType.MISC)
        t.add_abridge("АДМ.")
        CityItemToken.M_ONTOLOGY.add(t)
    ...
    def __load_big_city(xml0_ : xml.etree.ElementTree.Element) -> None:
        ...
        if (not Utils.isNullOrEmpty(adj)): 
            ...
            if (spb): 
                city_adj.add(Termin._new504(adj[6:], lang, ci))
    ...
    def try_parse(t : 'Token', prev : 'CityItemToken'=None, dont_normalize : bool=False, ad : 'GeoAnalyzerData'=None) -> 'CityItemToken':
        ...
        if (t.is_value("НП", None)): 
            res0 = CityItemToken._new1458(t, t, CityItemToken.ItemType.NOUN, "населенный пункт", True)
            ...
            if (ttt is not None): 
                ...
                if (ok): 
                    ...
                    if (next0__ is not None and next0__.typ == CityItemToken.ItemType.PROPERNAME): 
                        return CityItemToken._new1459(t, ttt.end_token, CityItemToken.ItemType.NOUN, "участок")
            ...
            if (res is None): 
                ...
                if (det is not None): 
                    ...
                    while ttt is not None and ttt.end_char <= det.end_char: 
                        ...
                        ttt = ttt.next0_
                    if (cou < 6): 
                        re = CityItemToken._new1440(det.begin_token, det.end_token, CityItemToken.ItemType.PROPERNAME)
        ...
        if (res is None): 
            ...
            if (isinstance(t, TextToken)): 
                ...
                if (txt == "ИМ" or txt == "ИМЕНИ"): 
                    ...
                    if (t1 is None): 
                        return None
                    nnn = CityItemToken._new1440(t1, t1, CityItemToken.ItemType.NOUN)
                ...
                if (isinstance(tt, TextToken)): 
                    ...
                    if (((txt == "Д" or txt == "С" or txt == "C") or txt == "П" or txt == "Х") or ((((txt == "А" or txt == "У")) and MiscLocationHelper.is_user_param_address(tt)))): 
                        if (tt.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt) or ((tt.next0_ is not None and tt.next0_.is_char_of(".,")))): 
                            ...
                            if (tokn is not None): 
                                return CityItemToken._new1459(tt, tokn.end_token, CityItemToken.ItemType.PROPERNAME, tokn.termin.canonic_text)
                            tt1 = tt
                            ...
                            if ((txt == "Д" and (isinstance(tt2, NumberToken)) and not tt2.is_newline_before) and not tt2.previous.is_comma): 
                                ...
                                if (not ok and tt1.next0_ is not None): 
                                    ...
                                    if (MiscLocationHelper.is_user_param_address(tt)): 
                                        noun = CityItemToken._new1459(tt, tt, CityItemToken.ItemType.NOUN, "СЕЛО")
                            ...
                            if (ok): 
                                res = CityItemToken._new1440(tt0, tt1, CityItemToken.ItemType.NOUN)
                                if (tt1.is_comma): 
                    ...
                    if ((txt == "СП" or txt == "РП" or txt == "ГП") or txt == "ДП"): 
                        ...
                        if (tt.next0_ is not None and tt.next0_.chars.is_capital_upper): 
                            return CityItemToken._new1466(tt0, tt, CityItemToken.ItemType.NOUN, True, Condition._new1465(t), ("РАБОЧИЙ ПОСЕЛОК" if txt == "РП" else (("ГОРОДСКОЕ ПОСЕЛЕНИЕ" if txt == "ГП" else (("ДАЧНЫЙ ПОСЕЛОК" if txt == "ДП" else "СЕЛЬСКОЕ ПОСЕЛЕНИЕ"))))))
                    ...
                    if (tt.chars.is_all_upper and tt.length_char > 2 and tt.chars.is_cyrillic_letter): 
                        return CityItemToken._new1459(tt, tt, CityItemToken.ItemType.PROPERNAME, tt.term)
            if ((isinstance(t, NumberToken)) and t.next0_ is not None): 
                ...
                if (net is not None and net.ex_typ == NumberExType.KILOMETER): 
                    return CityItemToken._new1459(t, net.end_token, CityItemToken.ItemType.PROPERNAME, "{0}КМ".format(math.floor(net.real_value)))
            ...
            if ((rt is not None and (isinstance(rt.referent, GeoReferent)) and rt.begin_token == rt.end_token) and rt.referent.is_state): 
                ...
                if (t.previous.morph.number == MorphNumber.SINGULAR and t.morph.case_.is_nominative and not t.morph.case_.is_genitive): 
                    return CityItemToken._new1459(t, t, CityItemToken.ItemType.PROPERNAME, rt.get_source_text().upper())
            return None
        if (res.typ == CityItemToken.ItemType.NOUN): 
    ...
    def __try_parse(t : 'Token', prev : 'CityItemToken', dont_normalize : bool, ad : 'GeoAnalyzerData') -> 'CityItemToken':
        ...
        if (not (isinstance(t, TextToken))): 
            if ((isinstance(t, ReferentToken)) and (isinstance(t.get_referent(), DateReferent))): 
                ...
                if (aii is not None): 
                    if (len(aii) > 1 and aii[0].typ == StreetItemType.NUMBER and aii[1].typ == StreetItemType.STDNAME): 
                        res2 = CityItemToken._new1440(t, aii[1].end_token, CityItemToken.ItemType.PROPERNAME)
            ...
            if ((isinstance(t, NumberToken)) and t.typ != NumberSpellingType.DIGIT and MiscLocationHelper.is_user_param_address(t)): 
                return CityItemToken._new1459(t, t, CityItemToken.ItemType.PROPERNAME, t.value)
            return None
                    ...
                    if (t.get_morph_class_in_dictionary().is_proper_name): 
                        ...
                        if (ters is not None): 
                            ...
                            if (ttt is not None): 
                                nam = (None)
                    if (nam is not None): 
                        res1 = CityItemToken._new1459(t, nam.end_token, CityItemToken.ItemType.PROPERNAME, nam.name)
                ...
                for nt in li: 
                    if (nt.item is not None and nt.item.canonic_text == tt.term): 
                        if (MiscLocationHelper.is_user_param_address(nt) or not MiscHelper.is_all_characters_lower(nt.begin_token, nt.end_token, False)): 
                            ci = CityItemToken._new1473(nt.begin_token, nt.end_token, CityItemToken.ItemType.CITY, nt.item, nt.morph)
            ...
            if (li is not None): 
                for nt in li: 
                    if (nt.item is None): 
                        ...
                        ci = CityItemToken._new1475(nt.begin_token, nt.end_token, ty, nt.morph)
        ...
        if (t.term == "СПБ" and not t.chars.is_all_lower and CityItemToken.M_ST_PETERBURG is not None): 
            return CityItemToken._new1476(t, t, CityItemToken.ItemType.CITY, CityItemToken.M_ST_PETERBURG, CityItemToken.M_ST_PETERBURG.canonic_text)
        if (t.term == "НЕТ"): 
            return None
        ...
        if (k > 0): 
            if (k > 2): 
                return None
            reee = CityItemToken._new1458(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), doubt)
            if (altname is not None): 
        ...
        if ((npt is not None and npt.end_token != t and len(npt.adjectives) > 0) and not npt.adjectives[0].end_token.next0_.is_comma): 
            ...
            if (cit is not None and cit.typ == CityItemToken.ItemType.NOUN and ((LanguageHelper.ends_with_ex(cit.value, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК") or t.next0_.is_value("ГОРОДОК", None) or t.next0_.is_value("СЕЛО", None)))): 
                ...
                if (not mc.is_adjective): 
                    ...
                    ok2 = True
                if (ok2): 
                    return CityItemToken._new1478(t, t, CityItemToken.ItemType.CITY, t.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), npt.morph)
            check_ = True
                ...
                if (npt is not None): 
                    ...
                    if (npt1 is None or len(npt1.adjectives) == 0): 
                        ...
                        if ((si is None or si.typ != StreetItemType.NOUN or si.termin.canonic_text == "МОСТ") or si.termin.canonic_text == "ПАРК" or si.termin.canonic_text == "САД"): 
                            ...
                            return CityItemToken._new1479(t, t1, CityItemToken.ItemType.PROPERNAME, npt.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), doubt, npt.morph)
                ...
                if (not ok1 and t.get_morph_class_in_dictionary().is_proper_name and MiscLocationHelper.is_user_param_address(t)): 
                    ...
                    if (pp is not None and pp.end_token != t and (isinstance(pp.end_token, TextToken))): 
                        if (TerrItemToken.check_keyword(pp.end_token.next0_) is None): 
                            return CityItemToken._new1480(t, pp.end_token, CityItemToken.ItemType.PROPERNAME, pp.end_token.term, MiscHelper.get_text_value_of_meta_token(pp, GetTextAttr.NO), pp.morph)
                if (ok1): 
                    ...
                    if (tne is not None and tne.typ == CityItemToken.ItemType.NOUN): 
                        ...
                        t1 = t.next0_
                        return CityItemToken._new1481(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.next0_.morph)
        if (t.length_char < 2): 
            return None
        ...
        if (StreetItemToken.check_keyword(t)): 
            if (AddressItemToken.check_street_after(t, False)): 
                if (prev is not None and prev.typ == CityItemToken.ItemType.NOUN and t.chars.is_capital_upper): 
                    ...
                    return None
        res = CityItemToken._new1481(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.morph)
    ...
    def __try_parse_spec(t : 'Token') -> 'CityItemToken':
        ...
        if (org0_ is not None): 
            return CityItemToken._new1483(t, org0_.end_token, CityItemToken.ItemType.PROPERNAME, org0_)
        tok1 = CityItemToken.M_SPEC_NAMES.try_parse(t, TerminParseAttr.NO)
        if (tok1 is not None): 
            res = CityItemToken._new1459(t, tok1.end_token, CityItemToken.ItemType.PROPERNAME, tok1.termin.canonic_text)
        ...
        if (tok1 is not None): 
            ...
            if (BracketHelper.can_be_start_of_sequence(tt, True, False)): 
                ...
                if (br is not None): 
                    res = CityItemToken._new1440(t, br.end_token, CityItemToken.ItemType.PROPERNAME)
                    res.value = MiscHelper.get_text_value_of_meta_token(br, GetTextAttr.NO)
            elif (tt is not None): 
                tmp = CityItemToken._new1459(tt.previous, tt.previous, CityItemToken.ItemType.NOUN, "ГОРОД")
        ...
        while True:
            ...
            if (only_noun): 
                ...
                if (vv is not None and vv.end_token == t): 
                    return CityItemToken._new1459(tt, t, CityItemToken.ItemType.NOUN, vv.termin.canonic_text)
            else: 
    ...
    @staticmethod
    def _new1440(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1458(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1459(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1466(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool, _arg5 : 'Condition', _arg6 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.doubtful = _arg4
        res._cond = _arg5
    ...
    @staticmethod
    def _new1473(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1475(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1476(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1478(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1479(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1480(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1481(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : bool, _arg7 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1483(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'ReferentToken') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.org_ref = _arg4
        return res