...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn3601 = RefOutArgWrapper(0)
        inoutres3602 = Utils.tryParseInt(self.__m_value, wrapn3601)
        n = wrapn3601.value
        if (inoutres3602): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new666(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
