...
class TextToken(Token):
    ...
    def check_value(self, dict0_ : typing.List[tuple]) -> object:
        ...
        if (dict0_ is None): 
            return None
        res = None
        wrapres3628 = RefOutArgWrapper(None)
        inoutres3629 = Utils.tryGetValue(dict0_, self.term, wrapres3628)
        res = wrapres3628.value
        if (inoutres3629): 
            return res
            ...
            for it in self.morph.items: 
                ...
                if (mf is not None): 
                    if (mf.normal_case is not None): 
                        wrapres3624 = RefOutArgWrapper(None)
                        inoutres3625 = Utils.tryGetValue(dict0_, mf.normal_case, wrapres3624)
                        res = wrapres3624.value
                        if (inoutres3625): 
                            return res
                    if (mf.normal_full is not None and mf.normal_case != mf.normal_full): 
                        wrapres3626 = RefOutArgWrapper(None)
                        inoutres3627 = Utils.tryGetValue(dict0_, mf.normal_full, wrapres3626)
                        res = wrapres3626.value
                        if (inoutres3627): 
                            return res
        return None
    ...
    def get_normal_case_text(self, mc : 'MorphClass'=None, num : 'MorphNumber'=MorphNumber.UNDEFINED, gender : 'MorphGender'=MorphGender.UNDEFINED, keep_chars : bool=False) -> str:
        ...
        if (num == MorphNumber.SINGULAR and mc is not None): 
            bi = MorphBaseInfo._new646(MorphClass._new53(mc.value), gender, MorphNumber.SINGULAR, self.morph.language)
            vars0_ = None
            try: 
                vars0_ = MorphologyService.get_wordform(self.term, bi)
            except Exception as ex3632: 
                pass
    ...
    @staticmethod
    def _new624(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.term0 = _arg5
        return res
    
    @staticmethod
    def _new627(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : 'CharsInfo', _arg6 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.chars = _arg5
        res.term0 = _arg6
        return res