...
class DateRangeReferent(Referent):
    ...
    def calculate_date_range(self, now : datetime.datetime, from0_ : datetime.datetime, to : datetime.datetime, tense : int=0) -> bool:
        ...
        inoutres1015 = DateRelHelper.calculate_date_range2(self, now, from0_, to, tense)
        return inoutres1015
    ...
    @staticmethod
    def _new927(_arg1 : 'DateReferent', _arg2 : 'DateReferent') -> 'DateRangeReferent':
    ...
    @staticmethod
    def _new933(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_to = _arg1
        return res
    
    @staticmethod
    def _new934(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_from = _arg1
        return res