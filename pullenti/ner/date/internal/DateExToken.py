...
class DateExToken(MetaToken):
    ...
    class DateValues:
            ...
            if (list0_ is not None): 
                for v in list0_: 
                    if (v.typ != DateExToken.DateExItemTokenType.HOUR and v.typ != DateExToken.DateExItemTokenType.MINUTE): 
                        oo = True
            if (not oo): 
                return DateExToken.DateValues._new785(today.year, today.month, today.day)
            ...
            while j < len(list0_): 
                if (list0_[j].typ == DateExToken.DateExItemTokenType.DAYOFWEEK): 
                    if (j > 0 and list0_[j - 1].typ == DateExToken.DateExItemTokenType.WEEK): 
                        break
                    we = DateExToken.DateExItemToken._new786(list0_[j].begin_token, list0_[j].end_token, DateExToken.DateExItemTokenType.WEEK, True)
        ...
        @staticmethod
        def _new785(_arg1 : int, _arg2 : int, _arg3 : int) -> 'DateValues':
            res = DateExToken.DateValues()
            res.year1 = _arg1
            res.month1 = _arg2
            res.day1 = _arg3
    ...
    class DateExItemToken(MetaToken):
        ...
        def try_parse(t : 'Token', prev : typing.List['DateExItemToken'], level : int=0, no_corr_after : bool=False) -> 'DateExItemToken':
            ...
            if (t.is_value("СЕГОДНЯ", "СЬОГОДНІ") or t.is_value("TODAY", None)): 
                return DateExToken.DateExItemToken._new792(t, t, DateExToken.DateExItemTokenType.DAY, 0, True)
            if (t.is_value("ЗАВТРА", None) or t.is_value("TOMORROW", None)): 
                return DateExToken.DateExItemToken._new792(t, t, DateExToken.DateExItemTokenType.DAY, 1, True)
            if (t.is_value("ЗАВТРАШНИЙ", "ЗАВТРАШНІЙ") and t.next0_ is not None and t.next0_.is_value("ДЕНЬ", None)): 
                return DateExToken.DateExItemToken._new792(t, t.next0_, DateExToken.DateExItemTokenType.DAY, 1, True)
            if (t.is_value("ПОСЛЕЗАВТРА", "ПІСЛЯЗАВТРА")): 
                return DateExToken.DateExItemToken._new792(t, t, DateExToken.DateExItemTokenType.DAY, 2, True)
            if (t.is_value("ПОСЛЕЗАВТРАШНИЙ", "ПІСЛЯЗАВТРАШНІЙ") and t.next0_ is not None and t.next0_.is_value("ДЕНЬ", None)): 
                return DateExToken.DateExItemToken._new792(t, t.next0_, DateExToken.DateExItemTokenType.DAY, 2, True)
            ...
            if (t.is_value("ПОЛЧАСА", "ПІВГОДИНИ")): 
                return DateExToken.DateExItemToken._new792(t, t, DateExToken.DateExItemTokenType.MINUTE, 30, True)
            if (t.is_value("ЗИМА", None)): 
                return DateExToken.DateExItemToken._new811(t, t, DateExToken.DateExItemTokenType.SEASON, 1)
            if (t.is_value("ВЕСНА", None)): 
                return DateExToken.DateExItemToken._new811(t, t, DateExToken.DateExItemTokenType.SEASON, 2)
            if (t.is_value("ЛЕТО", "ЛІТО") and not t.is_value("ЛЕТ", None)): 
                return DateExToken.DateExItemToken._new811(t, t, DateExToken.DateExItemTokenType.SEASON, 3)
            if (t.is_value("ОСЕНЬ", "ОСЕНІ")): 
                return DateExToken.DateExItemToken._new811(t, t, DateExToken.DateExItemTokenType.SEASON, 4)
            if (prev is not None and len(prev) > 0): 
                if (((t.is_value("Т", None) and t.next0_ is not None and t.next0_.is_char('.')) and t.next0_.next0_ is not None and t.next0_.next0_.is_value("Г", None)) and t.next0_.next0_.next0_ is not None and t.next0_.next0_.next0_.is_char('.')): 
                    return DateExToken.DateExItemToken._new786(t, t.next0_.next0_.next0_, DateExToken.DateExItemTokenType.YEAR, True)
                ...
                if ((isinstance(t, NumberToken)) and t.int_value is not None): 
                    if (t.next0_ is not None): 
                        if (t.next0_.is_value("УТРА", None)): 
                            return DateExToken.DateExItemToken._new811(t, t.next0_, DateExToken.DateExItemTokenType.HOUR, t.int_value)
                        if (t.next0_.is_value("ВЕЧЕРА", None)): 
                            res1 = DateExToken.DateExItemToken._new811(t, t.next0_, DateExToken.DateExItemTokenType.HOUR, t.int_value)
                            if (res1.value < 12): 
                                res1.value += 12
                            return res1
                        if (t.next0_.is_value("ЧАС", None) and t.next0_.next0_ is not None): 
                            if (t.next0_.next0_.is_value("УТРА", None)): 
                                return DateExToken.DateExItemToken._new811(t, t.next0_.next0_, DateExToken.DateExItemTokenType.HOUR, t.int_value)
                            if (t.next0_.next0_.is_value("ВЕЧЕРА", None) or t.next0_.next0_.is_value("ДНЯ", None)): 
                                res1 = DateExToken.DateExItemToken._new811(t, t.next0_.next0_, DateExToken.DateExItemTokenType.HOUR, t.int_value)
                                if (res1.value < 12): 
                                    res1.value += 12
                                return res1
                    ...
                    if (dtt is not None and dtt.typ == DateItemToken.DateItemType.YEAR): 
                        return DateExToken.DateExItemToken._new811(t, dtt.end_token, DateExToken.DateExItemTokenType.YEAR, dtt.int_value)
                    if (t.next0_ is not None and t.next0_.is_value("ЧИСЛО", None)): 
                        ...
                        if (ne is not None and ne.typ == DateExToken.DateExItemTokenType.MONTH): 
                            return DateExToken.DateExItemToken._new811(t, t.next0_, DateExToken.DateExItemTokenType.DAY, t.int_value)
                delt = 0
                ok = True
                last = False
                t1 = t
                    ...
                    while tt is not None: 
                        ...
                        if (dr is not None and dr.is_relative): 
                            ...
                            if (ty0 != DateExToken.DateExItemTokenType.UNDEFINED): 
                                return DateExToken.DateExItemToken._new792(t, t, ty0, delt, True)
            ...
            if (npt.noun.is_value("ГОД", "РІК") or npt.noun.is_value("ГОДИК", None) or npt.noun.is_value("ЛЕТ", None)): 
                ...
                if (dti is not None and dti.typ == DateItemToken.DateItemType.MONTH): 
                    ...
                    return None
            res = DateExToken.DateExItemToken._new811(t, npt.end_token, ty, val)
            heg = False
            i = 0
        ...
        @staticmethod
        def _new786(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : bool) -> 'DateExItemToken':
        ...
        @staticmethod
        def _new789(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : int, _arg5 : 'DateReferent') -> 'DateExItemToken':
            res = DateExToken.DateExItemToken(_arg1, _arg2)
            res.typ = _arg3
            res.value = _arg4
            res.src = _arg5
        ...
        @staticmethod
        def _new792(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : int, _arg5 : bool) -> 'DateExItemToken':
            res = DateExToken.DateExItemToken(_arg1, _arg2)
            res.typ = _arg3
            res.value = _arg4
        ...
        @staticmethod
        def _new811(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : int) -> 'DateExItemToken':
            res = DateExToken.DateExItemToken(_arg1, _arg2)
            res.typ = _arg3
            res.value = _arg4
            return res
        ...
        @staticmethod
        def _new882(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType') -> 'DateExItemToken':
            res = DateExToken.DateExItemToken(_arg1, _arg2)
            res.typ = _arg3
            return res
    ...
    def try_parse(t : 'Token') -> 'DateExToken':
        ...
        while True:
            ...
            if (drr is not None): 
                res = DateExToken._new787(t, tt, True)
                fr = drr.date_from
                if (fr is not None): 
            ...
            if (to_regime): 
                ...
                if (it.is_last and it.value != 0 and it.value != -1): 
                    res.items_to.append(DateExToken.DateExItemToken._new786(it.begin_token, it.end_token, it.typ, True))
                    from_regime = True
            tt = it.end_token
            res.end_token = tt
        if (res is not None): 
    ...
    def __add_items(fr : 'DateReferent', res : typing.List['DateExItemToken'], tt : 'Token') -> None:
        if (fr.century > 0): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.CENTURY, fr.century, fr))
        if (fr.decade > 0): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.DECADE, fr.decade, fr))
        if (fr.year > 0): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.YEAR, fr.year, fr))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new792(tt, tt, DateExToken.DateExItemTokenType.YEAR, 0, True))
        if (fr.month > 0): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.MONTH, fr.month, fr))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new792(tt, tt, DateExToken.DateExItemTokenType.MONTH, 0, True))
        if (fr.day > 0): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.DAY, fr.day, fr))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new792(tt, tt, DateExToken.DateExItemTokenType.DAY, 0, True))
        if (fr.find_slot(DateReferent.ATTR_HOUR, None, True) is not None): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.HOUR, fr.hour, fr))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new792(tt, tt, DateExToken.DateExItemTokenType.HOUR, 0, True))
        if (fr.find_slot(DateReferent.ATTR_MINUTE, None, True) is not None): 
            res.append(DateExToken.DateExItemToken._new789(tt, tt, DateExToken.DateExItemTokenType.MINUTE, fr.minute, fr))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new792(tt, tt, DateExToken.DateExItemTokenType.MINUTE, 0, True))
    
    @staticmethod
    def _new787(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'DateExToken':
